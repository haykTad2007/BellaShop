...
slidePrevious.onclick = () => {
  ...
  if(o === 0){
    o = slideArr.length - 1
    sliderImg.src = slideArr[o]
    slideTextSale.style.color =' rgb(224, 224, 64)'
    text.style.color = 'rgb(140, 83, 25)'
    text1.style.color = 'rgb(140, 83, 25)'
  ...
  if(o === 0){
    slideTextSale.style.color = 'rgb(64, 224, 64)'
    text.style.color = 'rgb(25, 25, 140)'
    text1.style.color = 'rgb(25, 25, 140)'
  }
  if(o === 1){
    slideTextSale.style.color = 'rgb(35, 177, 177)'
    text.style.color = 'rgb(203, 86, 131)'
    text1.style.color = 'rgb(203, 86, 131)'
  }
}
slideNext.onclick = () => {
